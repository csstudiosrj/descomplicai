...
// Documento PDF do memorial — layout elegante com identidade visual da noiva
...
import {
  ...
  // Registrar fontes (usar fontes seguras para PDF)
  Font.register({
    family: 'Cormorant',
    src: 'https://fonts.gstatic.com/s/cormorantgaramond/v21/co3YmX5slCNuHLi8bLeY9MK7whWMhyjYqXtK.woff2',
  });
