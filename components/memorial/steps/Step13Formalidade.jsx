...
export default function Step13Formalidade({ onSelect, estadoAtual }) {
  ...
  return (
    ...
    >
      <Card key={o.valor} interactive selected={isSelected} padding="lg" onClick={() => onSelect('formalidade', o.valor)} role="radio" aria-checked={isSelected} tabIndex={0} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); onSelect('formalidade', o.valor); } }}>
