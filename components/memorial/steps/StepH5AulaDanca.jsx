...
export default function StepH5AulaDanca({ onSelect, estadoAtual }) {
  ...
  return (
    <div
      role="radiogroup"
      aria-label="Desejam aula de dança para a valsa?"
      style={{
        maxWidth: '640px',
        margin: '0 auto',
        display: 'flex',
    ...
    >
      ...
      <div>
        ...
        <p style={{ fontFamily: 'var(--font-body)', color: 'var(--color-text-secondary)', lineHeight: 'var(--leading-relaxed)' }}>
          Desejam aula de dança para a valsa?
        </p>
      </div>
        ...
        {OPCOES.map((opcao) => {
          ...
          return (
            <Card
              ...
              selected={isSelected}
              padding="lg"
              onClick={() => onSelect('aulaDanca', opcao.valor)}
              role="radio"
...
StepH5AulaDanca.propTypes = {
  onSelect: PropTypes.func.isRequired,
  estadoAtual: PropTypes.object,
};

export { StepH5AulaDanca };
