...
const OPCOES = [
    {
      valor: 'inox',
      label: 'Inox polido',
      subtexto: 'Contemporâneo e atemporal',
      icone: 'scissors',
    },
    {
      valor: 'dourado',
      label: 'Dourado fosco',
      subtexto: 'Quente e elegante',
      icone: 'star',
    },
    {
      valor: 'prateado',
      label: 'Prateado',
      subtexto: 'Frio e neutro',
      icone: 'moon',
    },
    {
      valor: 'preto',
      label: 'Preto fosco',
      subtexto: 'Dramático e moderno',
      icone: 'square',
    },
];

export default function Step25Talheres({ onSelect, estadoAtual }) {
  const selecionado = estadoAtual?.talheres;

  return (
    <div
      role="radiogroup"
      aria-label="Qual acabamento dos talheres?"
      style={{
        maxWidth: '640px',
        margin: '0 auto',
        display: 'flex',
        ...
        {OPCOES.map((opcao) => {
          ...
          return (
            <Card
              ...
              selected={isSelected}
              padding="lg"
              onClick={() => onSelect('talheres', opcao.valor)}
              role="radio"
...
Step25Talheres.propTypes = {
  onSelect: PropTypes.func.isRequired,
  estadoAtual: PropTypes.object,
};

export { Step25Talheres };
