...
const OPCOES = [
    {
      valor: 'sim',
      label: 'Sim',
      subtexto: 'Quarteto, coral, violinista',
      icone: 'music',
    },
    {
      valor: 'nao',
      label: 'Não',
      subtexto: 'Playlist gravada',
      icone: 'list',
    },
    {
      valor: 'talvez',
...
export default function StepB7MusicaCerimoniaViva({ onSelect, estadoAtual }) {
  const selecionado = estadoAtual?.musicaCerimoniaViva;

  return (
    <div
      role="radiogroup"
      aria-label="Desejam música ao vivo na cerimônia?"
      style={
        maxWidth: '640px',
        margin: '0 auto',
        display: 'flex',
    ...
    >
      ...
      <div>
        ...
        <p style={ fontFamily: 'var(--font-body)', color: 'var(--color-text-secondary)', lineHeight: 'var(--leading-relaxed)' }>
          Desejam música ao vivo na cerimônia?
        </p>
      </div>
        ...
        {OPCOES.map((opcao) => {
          ...
          return (
            <Card
              ...
              selected={isSelected}
              padding="lg"
              onClick={() => onSelect('musicaCerimoniaViva', opcao.valor)}
              role="radio"
              ...
              onKeyDown={(e) => {
                if (e.key === 'Enter' || e.key === ' ') {
                  e.preventDefault();
                  onSelect('musicaCerimoniaViva', opcao.valor);
                }
              }}
            >
...
StepB7MusicaCerimoniaViva.propTypes = {
  onSelect: PropTypes.func.isRequired,
  estadoAtual: PropTypes.object,
};

export { StepB7MusicaCerimoniaViva };
