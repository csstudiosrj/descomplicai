...
export default function Step29CartaoLugar({ onSelect, estadoAtual }) {
  const selecionado = estadoAtual?.cartaoLugar;

  return (
    <div
      role="radiogroup"
      aria-label="Desejam cartão de lugar?"
      style={{
        maxWidth: '640px',
        margin: '0 auto',
        display: 'flex',
        ...
        {OPCOES.map((opcao) => {
          ...
          return (
            <Card
              ...
              selected={isSelected}
              padding="lg"
              onClick={() => onSelect('cartaoLugar', opcao.valor)}
              role="radio"
              ...
              onKeyDown={(e) => {
                if (e.key === 'Enter' || e.key === ' ') {
                  e.preventDefault();
                  onSelect('cartaoLugar', opcao.valor);
                }
              }}
            >
...
Step29CartaoLugar.propTypes = {
  onSelect: PropTypes.func.isRequired,
  estadoAtual: PropTypes.object,
};

export { Step29CartaoLugar };
