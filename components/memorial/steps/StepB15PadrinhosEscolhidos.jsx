...
export default function StepB15PadrinhosEscolhidos({ onSelect, estadoAtual }) {
  ...
  return (
    ...
    >
      <Card key={o.valor} interactive selected={isSelected} padding="lg" onClick={() => onSelect('padrinhosEscolhidosCerimonia', o.valor)} role="radio" aria-checked={isSelected} tabIndex={0} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); onSelect('padrinhosEscolhidosCerimonia', o.valor); } }}>
