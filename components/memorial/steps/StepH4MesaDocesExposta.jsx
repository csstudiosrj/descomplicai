...
export default function StepH4MesaDocesExposta({ onSelect, estadoAtual }) {
  const selecionado = estadoAtual?.mesaDocesExposta;

  return (
    <div
      role="radiogroup"
      aria-label="Desejam mesa de doces exposta?"
      style={{
        maxWidth: '640px',
        margin: '0 auto',
        display: 'flex',
        ...
        {OPCOES.map((opcao) => {
          ...
          return (
            <Card
              ...
              selected={isSelected}
              padding="lg"
              onClick={() => onSelect('mesaDocesExposta', opcao.valor)}
              role="radio"
              ...
              onKeyDown={(e) => {
                if (e.key === 'Enter' || e.key === ' ') {
                  e.preventDefault();
                  onSelect('mesaDocesExposta', opcao.valor);
                }
              }}
            >
...
StepH4MesaDocesExposta.propTypes = {
  onSelect: PropTypes.func.isRequired,
  estadoAtual: PropTypes.object,
};

export { StepH4MesaDocesExposta };
