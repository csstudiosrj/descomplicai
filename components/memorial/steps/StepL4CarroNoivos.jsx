...
export default function StepL4CarroNoivos({ onSelect, estadoAtual }) {
  ...
  return (
    <div
      role="radiogroup"
      aria-label="Terão carro exclusivo?"
      style={
        maxWidth: '640px',
        margin: '0 auto',
        display: 'flex',
        ...
        {OPCOES.map((opcao) => {
          ...
          return (
            <Card
              ...
              selected={isSelected}
              padding="lg"
              onClick={() => onSelect('carroNoivos', opcao.valor)}
              role="radio"
              ...
              onKeyDown={(e) => {
                if (e.key === 'Enter' || e.key === ' ') {
                  e.preventDefault();
                  onSelect('carroNoivos', opcao.valor);
                }
              }}
            >
...
StepL4CarroNoivos.propTypes = {
  onSelect: PropTypes.func.isRequired,
  estadoAtual: PropTypes.object,
};

export { StepL4CarroNoivos };
