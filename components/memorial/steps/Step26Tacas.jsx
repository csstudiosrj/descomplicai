...
const OPCOES = [
    {
      valor: 'cristal',
      label: 'Cristal',
      subtexto: 'Transparente e clássico',
      icone: 'wine',
    },
    {
      valor: 'borda_dourada',
      label: 'Borda dourada',
      subtexto: 'Toque de luxo',
      icone: 'crown',
    },
    {
      valor: 'fume',
      label: 'Fumê',
      subtexto: 'Moderno e ousado',
      icone: 'droplet',
    },
    {
      valor: 'colorida',
      label: 'Colorida',
      subtexto: 'Vintage e divertida',
      icone: 'palette',
    },
];

export default function Step26Tacas({ onSelect, estadoAtual }) {
  const selecionado = estadoAtual?.tacas;

  return (
    <div
      role="radiogroup"
      aria-label="Qual estilo de taças?"
      style={{
        maxWidth: '640px',
        margin: '0 auto',
        display: 'flex',
        ...
        {OPCOES.map((opcao) => {
          ...
          return (
            <Card
              ...
              selected={isSelected}
              padding="lg"
              onClick={() => onSelect('tacas', opcao.valor)}
              role="radio"
