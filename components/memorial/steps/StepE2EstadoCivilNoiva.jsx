// StepE2EstadoCivilNoiva — Qual o estado civil da noiva?
...
const OPCOES = [
  ...
  { valor: "divorciado", label: "Divorciada", desc: "Já teve casamento civil anterior" },
...
export default function StepE2EstadoCivilNoiva({ onSelect, estadoAtual }) {
  ...
  return (
    <div role="radiogroup" aria-label="Estado civil da noiva" style={{ maxWidth: '640px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 'var(--space-6)', animation: 'fadeInUp 300ms ease-out' }}>
      <style jsx>{`@keyframes fadeInUp { from { opacity: 0; transform: translateY(12px); } to { opacity: 1; transform: translateY(0); } }`}</style>

      <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 'var(--text-3xl)', color: 'var(--color-text-primary)' }}>
        Qual o estado civil da noiva?
      </h1>
