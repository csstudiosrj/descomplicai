...
export default function StepL6Seguranca({ onSelect, estadoAtual }) {
  const selecionado = estadoAtual?.seguranca;

  return (
    <div
      role="radiogroup"
      aria-label="Desejam segurança no evento?"
      style={{
        maxWidth: '640px',
        margin: '0 auto',
        display: 'flex',
        ...
        {OPCOES.map((opcao) => {
          ...
          return (
            <Card
              ...
              selected={isSelected}
              padding="lg"
              onClick={() => onSelect('seguranca', opcao.valor)}
              role="radio"
              ...
              onKeyDown={(e) => {
                if (e.key === 'Enter' || e.key === ' ') {
                  e.preventDefault();
                  onSelect('seguranca', opcao.valor);
                }
              }}
            >
...
StepL6Seguranca.propTypes = {
  onSelect: PropTypes.func.isRequired,
  estadoAtual: PropTypes.object,
};

export { StepL6Seguranca };
