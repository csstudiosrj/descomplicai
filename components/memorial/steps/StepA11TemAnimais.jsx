...
export default function StepA11TemAnimais({ onSelect, estadoAtual }) {
  ...
  return (
    ...
    >
      <Card key={o.valor} interactive selected={isSelected} padding="lg" onClick={() => onSelect('temAnimais', o.valor)} role="radio" aria-checked={isSelected} tabIndex={0} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); onSelect('temAnimais', o.valor); } }}>
