...
const OPCOES = [
    {
      valor: '30min',
      label: '30 minutos',
      subtexto: 'Cerimônia curta e objetiva',
      icone: 'clock',
    },
    {
      valor: '1h',
      label: '1 hora',
      subtexto: 'Cerimônia tradicional',
      icone: 'clock',
    },
    {
      valor: 'mais_1h',
      label: 'Mais de 1 hora',
      subtexto: 'Cerimônia com rituais e celebrações',
      icone: 'clock',
    },
];

export default function StepB6DuracaoCerimonia({ onSelect, estadoAtual }) {
  const selecionado = estadoAtual?.duracaoCerimonia;

  return (
    <div
      role="radiogroup"
      aria-label="Quanto tempo dura a cerimônia?"
      style={{
        maxWidth: '640px',
        margin: '0 auto',
        display: 'flex',
        ...
        {OPCOES.map((opcao) => {
          ...
          return (
            <Card
              ...
              selected={isSelected}
              padding="lg"
              onClick={() => onSelect('duracaoCerimonia', opcao.valor)}
              role="radio"
              ...
              onKeyDown={(e) => {
                if (e.key === 'Enter' || e.key === ' ') {
                  e.preventDefault();
                  onSelect('duracaoCerimonia', opcao.valor);
                }
              }}
            >
...
StepB6DuracaoCerimonia.propTypes = {
  onSelect: PropTypes.func.isRequired,
  estadoAtual: PropTypes.object,
};

export { StepB6DuracaoCerimonia };
