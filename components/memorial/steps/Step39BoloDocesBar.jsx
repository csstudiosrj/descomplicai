...
const OPCOES = [
    {
      valor: 'open_bar_completo',
      label: 'Open bar completo',
      subtexto: 'Bebidas alcoólicas e não alcoólicas',
      icone: 'wine',
    },
    {
      valor: 'open_bar_limitado',
      label: 'Open bar limitado',
      subtexto: 'Sem destilados',
      icone: 'glass',
    },
    {
      valor: 'cerveja_refrigerante',
      label: 'Cerveja e refrigerante',
      subtexto: 'Opções básicas',
      icone: 'droplet',
    },
    {
      valor: 'sem_alcool',
      label: 'Sem álcool',
      subtexto: 'Sucos, refrigerantes, água',
      icone: 'coffee',
    },
];

export default function Step39BoloDocesBar({ onSelect, estadoAtual }) {
  const selecionado = estadoAtual?.tipoBar;

  return (
    <div
      role="radiogroup"
      aria-label="O que terá na recepção?"
      style={
        maxWidth: '640px',
        margin: '0 auto',
        display: 'flex',
        ...
        {OPCOES.map((opcao) => {
          ...
          return (
            <Card
              ...
              selected={isSelected}
              padding="lg"
              onClick={() => onSelect('tipoBar', opcao.valor)}
              role="radio"
...
Step39BoloDocesBar.propTypes = {
  onSelect: PropTypes.func.isRequired,
  estadoAtual: PropTypes.object,
};

export { Step39BoloDocesBar };
