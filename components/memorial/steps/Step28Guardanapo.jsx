...
const OPCOES = [
    {
      valor: 'linho_branco',
      label: 'Linho branco',
      subtexto: 'Discreto e elegante',
      icone: 'square',
    },
    {
      valor: 'no_fita',
      label: 'Nó com fita',
      subtexto: 'Boho e delicado',
      icone: 'link',
    },
    {
      valor: 'porta_guardanapo',
      label: 'Porta-guardanapo metálico',
      subtexto: 'Industrial e moderno',
      icone: 'circle',
    },
    {
      valor: 'dobra_monograma',
      label: 'Dobra com monograma',
      subtexto: 'Clássico personalizado',
      icone: 'type',
    },
];

export default function Step28Guardanapo({ onSelect, estadoAtual }) {
  const selecionado = estadoAtual?.guardanapo;

  return (
    <div
      role="radiogroup"
      aria-label="Qual estilo de guardanapo?"
      style={{
        maxWidth: '640px',
        margin: '0 auto',
        display: 'flex',
        ...
        {OPCOES.map((opcao) => {
          ...
          return (
            <Card
              ...
              selected={isSelected}
              padding="lg"
              onClick={() => onSelect('guardanapo', opcao.valor)}
              role="radio"
              ...
              onKeyDown={(e) => {
                if (e.key === 'Enter' || e.key === ' ') {
                  e.preventDefault();
                  onSelect('guardanapo', opcao.valor);
                }
              }}
            >
...
Step28Guardanapo.propTypes = {
  onSelect: PropTypes.func.isRequired,
  estadoAtual: PropTypes.object,
};

export { Step28Guardanapo };
