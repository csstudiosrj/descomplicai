...
const OPCOES = [
    {
      valor: 'sim',
      label: 'Sim',
      subtexto: 'Viagem de lua de mel planejada',
      icone: 'plane',
    },
    {
      valor: 'nao',
      label: 'Não',
      subtexto: 'Sem lua de mel',
      icone: 'x',
    },
    {
      valor: 'em_pesquisa',
      label: 'Em pesquisa',
      subtexto: 'Ainda estamos decidindo o destino',
      icone: 'search',
    },
];

export default function StepM1LuaDeMel({ onSelect, estadoAtual }) {
  const selecionado = estadoAtual?.luaDeMel;

  return (
    <div
      role="radiogroup"
      aria-label="Terão lua de mel?"
      style={
        maxWidth: '640px',
        margin: '0 auto',
        display: 'flex',
        ...
        {OPCOES.map((opcao) => {
          ...
          return (
            <Card
              ...
              selected={isSelected}
              padding="lg"
              onClick={() => onSelect('luaDeMel', opcao.valor)}
              role="radio"
...
StepM1LuaDeMel.propTypes = {
  onSelect: PropTypes.func.isRequired,
  estadoAtual: PropTypes.object,
};

export { StepM1LuaDeMel };
