...
const OPCOES = [
    {
      valor: 'True',
      label: 'Sim',
      subtexto: 'Velas decorativas para ambiente romântico',
      icone: 'flame',
    },
    {
      valor: 'False',
...
export default function Step19Velas({ onSelect, estadoAtual }) {
  const selecionado = estadoAtual?.velas;

  return (
    <div
      role="radiogroup"
      aria-label="Desejam velas na decoração?"
      style={
        maxWidth: '640px',
        margin: '0 auto',
        display: 'flex',
        ...
        {OPCOES.map((opcao) => {
          ...
          return (
            <Card
              ...
              selected={isSelected}
              padding="lg"
              onClick={() => onSelect('velas', opcao.valor)}
              role="radio"
