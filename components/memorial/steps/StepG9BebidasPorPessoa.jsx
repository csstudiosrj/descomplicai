...
const OPCOES = [
    {
      valor: 'livre',
      label: 'Livre',
      subtexto: 'Open bar sem controle',
      icone: 'wine',
    },
    {
      valor: 'controlado',
      label: 'Controlado',
      subtexto: 'Por pessoa ou por mesa',
      icone: 'bar',
    },
];

export default function StepG9BebidasPorPessoa({ onSelect, estadoAtual }) {
  const selecionado = estadoAtual?.bebidasPorPessoa;

  return (
    <div
      role="radiogroup"
      aria-label="Como será o controle de bebidas?"
      style={{
        maxWidth: '640px',
        margin: '0 auto',
        display: 'flex',
    ...
    >
      ...
      <div>
        ...
        <p style={{ fontFamily: 'var(--font-body)', color: 'var(--color-text-secondary)', lineHeight: 'var(--leading-relaxed)' }}>
          Como será o controle de bebidas?
        </p>
      </div>
        ...
        {OPCOES.map((opcao) => {
          ...
          return (
            <Card
              ...
              selected={isSelected}
              padding="lg"
              onClick={() => onSelect('bebidasPorPessoa', opcao.valor)}
              role="radio"
              ...
              onKeyDown={(e) => {
                if (e.key === 'Enter' || e.key === ' ') {
                  e.preventDefault();
                  onSelect('bebidasPorPessoa', opcao.valor);
                }
              }}
            >
...
StepG9BebidasPorPessoa.propTypes = {
  onSelect: PropTypes.func.isRequired,
  estadoAtual: PropTypes.object,
};

export { StepG9BebidasPorPessoa };
