...
const OPCOES = [
    {
      valor: 'True',
      label: 'Sim',
      subtexto: 'Painel decorativo para fotos dos convidados',
      icone: 'camera',
    },
    {
      valor: 'False',
      label: 'Não',
      subtexto: 'Sem backdrop dedicado',
      icone: 'x',
    },
];

export default function Step21Backdrop({ onSelect, estadoAtual }) {
  const selecionado = estadoAtual?.backdrop;

  return (
    <div
      role="radiogroup"
      aria-label="Desejam um backdrop para fotos?"
      style={{
        maxWidth: '640px',
        margin: '0 auto',
        display: 'flex',
    ...
    >
      ...
      <div>
        ...
        <p style={{ fontFamily: 'var(--font-body)', color: 'var(--color-text-secondary)', lineHeight: 'var(--leading-relaxed)' }}>
          Desejam um backdrop para fotos?
        </p>
      </div>
        ...
        {OPCOES.map((opcao) => {
          ...
          return (
            <Card
              ...
              selected={isSelected}
              padding="lg"
              onClick={() => onSelect('backdrop', opcao.valor)}
              role="radio"
...
Step21Backdrop.propTypes = {
  onSelect: PropTypes.func.isRequired,
  estadoAtual: PropTypes.object,
};

export { Step21Backdrop };
