...
const OPCOES = [
    {
      valor: 'arranjo_floral',
      label: 'Arranjo floral',
      subtexto: 'Romântico e natural',
      icone: 'flower',
    },
    {
      valor: 'velas',
      label: 'Velas agrupadas',
      subtexto: 'Aconchegante e íntimo',
      icone: 'flame',
    },
    {
      valor: 'lanternas',
      label: 'Lanternas',
      subtexto: 'Rústico e charmoso',
      icone: 'lamp',
    },
    {
      valor: 'geometrico',
      label: 'Geométrico/escultural',
      subtexto: 'Moderno e impactante',
      icone: 'box',
    },
];

export default function Step27CentroMesa({ onSelect, estadoAtual }) {
  const selecionado = estadoAtual?.centroMesa;

  return (
    <div
      role="radiogroup"
      aria-label="Qual estilo de centro de mesa?"
      style={{
        maxWidth: '640px',
        margin: '0 auto',
        display: 'flex',
        ...
        {OPCOES.map((opcao) => {
          ...
          return (
            <Card
              ...
              selected={isSelected}
              padding="lg"
              onClick={() => onSelect('centroMesa', opcao.valor)}
              role="radio"
              ...
              onKeyDown={(e) => {
                if (e.key === 'Enter' || e.key === ' ') {
                  e.preventDefault();
                  onSelect('centroMesa', opcao.valor);
                }
              }}
            >
...
Step27CentroMesa.propTypes = {
  onSelect: PropTypes.func.isRequired,
  estadoAtual: PropTypes.object,
};

export { Step27CentroMesa };
