...
export default function StepA13PersonalidadeNoivo({ onSelect, estadoAtual }) {
  ...
  return (
    <div
      role="radiogroup"
      aria-label={termos.tituloPersonalidadePessoa2 || 'Personalidade da pessoa 2'}
      style={{
        maxWidth: '640px',
        margin: '0 auto',
        display: 'flex',
    ...
    >
      ...
      <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 'var(--text-3xl)', color: 'var(--color-text-primary)' }}>
        {termos.tituloPersonalidadePessoa2 || 'Personalidade da pessoa 2'}
      </h1>
            ...
            >
              ...
              >
                <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-2)' }}>
                  ...
                  {isSelected && (
                    <span aria-hidden="true" style={{ marginTop: 'var(--space-1)', color: 'var(--color-brand)', fontWeight: 'var(--font-bold)' }}>
                      ✓ Selecionado
                    </span>
                  )}
                </div>
