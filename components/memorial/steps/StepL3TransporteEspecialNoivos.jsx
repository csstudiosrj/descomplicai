...
export default function StepL3TransporteEspecialNoivos({ onSelect, estadoAtual }) {
  ...
  return (
    <div
      role="radiogroup"
      aria-label="Desejam transporte especial?"
      style={{
        maxWidth: '640px',
        margin: '0 auto',
        display: 'flex',
        ...
        {OPCOES.map((opcao) => {
          ...
          return (
            <Card
              ...
              selected={isSelected}
              padding="lg"
              onClick={() => onSelect('transporteEspecialNoivos', opcao.valor)}
              role="radio"
              ...
              onKeyDown={(e) => {
                if (e.key === 'Enter' || e.key === ' ') {
                  e.preventDefault();
                  onSelect('transporteEspecialNoivos', opcao.valor);
                }
              }}
            >
