...
export default function Step17Flores({ onSelect, estadoAtual }) {
  ...
  return (
    ...
    >
      <Card key={String(opcao.valor)} interactive selected={isSelected} padding="lg" onClick={() => handleCardClick(opcao)} role="radio" aria-checked={isSelected} tabIndex={0} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); onSelect('flores', opcao.valor); } }}>
