...
export default function StepE6CertidaoObitoNoiva({ onSelect, estadoAtual }) {
  ...
  return (
    <div role="radiogroup" aria-label={`Certidão de óbito da ${termos.pessoa1}`} style={{ maxWidth: '640px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 'var(--space-6)', animation: 'fadeInUp 300ms ease-out' }}>
