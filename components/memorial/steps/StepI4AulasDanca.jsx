...
export default function StepI4AulasDanca({ onSelect, estadoAtual }) {
  ...
  return (
    <div
      role="radiogroup"
      aria-label="Desejam aulas de dança em grupo?"
      style={{
        maxWidth: '640px',
        margin: '0 auto',
        display: 'flex',
    ...
    >
      ...
      <div>
        ...
        <p style={{ fontFamily: 'var(--font-body)', color: 'var(--color-text-secondary)', lineHeight: 'var(--leading-relaxed)' }}>
          Desejam aulas de dança em grupo?
        </p>
      </div>
    ...
    >
      <Card
              ...
              onKeyDown={(e) => {
                if (e.key === 'Enter' || e.key === ' ') {
                  e.preventDefault();
                  onSelect('aulasDanca', opcaopcao.valor);
                }
              }}
            >
...
StepI4AulasDanca.propTypes = {
  onSelect: PropTypes.func.isRequired,
  estadoAtual: PropTypes.object,
};

export { StepI4AulasDanca };