...
const OPCOES = [
    {
      valor: 'sim',
      label: 'Sim',
      subtexto: 'Várias crianças presentes',
      icone: 'baby',
    },
    {
      valor: 'nao',
      label: 'Não',
      subtexto: 'Apenas adultos',
      icone: 'x',
    },
    {
      valor: 'alguns',
      label: 'Alguns',
      subtexto: 'Poucas crianças',
      icone: 'users',
    },
];

export default function StepA4Criancas({ onSelect, estadoAtual }) {
  const selecionado = estadoAtual?.criancas;

  return (
    <div
      role="radiogroup"
      aria-label="Terão crianças na festa?"
      style={{
        maxWidth: '640px',
        margin: '0 auto',
        display: 'flex',
        ...
        {OPCOES.map((opcao) => {
          ...
          return (
            <Card
              ...
              selected={isSelected}
              padding="lg"
              onClick={() => onSelect('criancas', opcao.valor)}
              role="radio"
...
StepA4Criancas.propTypes = {
  onSelect: PropTypes.func.isRequired,
  estadoAtual: PropTypes.object,
};

export { StepA4Criancas };
