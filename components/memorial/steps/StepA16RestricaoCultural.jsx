// StepA16RestricaoCultural — Há alguma restrição religiosa ou cultural?
  ...
  return (
    <div style={{ maxWidth: '480px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 'var(--space-5)', animation: 'fadeInUp 300ms ease-out' }}>
      ...
      <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 'var(--text-3xl)', color: 'var(--color-text-primary)' }}>
        Há alguma restrição religiosa ou cultural?
      </h1>
      <p style={{ fontFamily: 'var(--font-body)', color: 'var(--color-text-secondary)' }}>
        Isso nos ajuda a respeitar e sugerir fornecedores adequados.
      </p>

      <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
        <Input label="Restrição" value={valor} onChange={(e) => setValor(e.target.value)} placeholder="Ex: Não servimos carne vermelha, cerimônia deve ser antes do pôr do sol"  />
      </div>
...
StepA16RestricaoCultural.propTypes = {
  onSelect: PropTypes.func.isRequired,
  estadoAtual: PropTypes.object,
};

export { StepA16RestricaoCultural };
