...
const OPCOES = [
    {
      valor: 'True',
      label: 'Sim',
      subtexto: 'Drapes, cortinas, tecidos suspensos',
      icone: 'wind',
    },
    {
      valor: 'False',
      label: 'Não',
      subtexto: 'Sem tecidos decorativos',
      icone: 'x',
    },
];

export default function Step22Tecidos({ onSelect, estadoAtual }) {
  const selecionado = estadoAtual?.tecidos;

  return (
    <div
      role="radiogroup"
      aria-label="Desejam tecidos na decoração?"
      style={
        maxWidth: '640px',
        margin: '0 auto',
        display: 'flex',
        ...
        {OPCOES.map((opcao) => {
          ...
          return (
            <Card
              ...
              selected={isSelected}
              padding="lg"
              onClick={() => onSelect('tecidos', opcao.valor)}
              role="radio"
...
Step22Tecidos.propTypes = {
  onSelect: PropTypes.func.isRequired,
  estadoAtual: PropTypes.object,
};

export { Step22Tecidos };
