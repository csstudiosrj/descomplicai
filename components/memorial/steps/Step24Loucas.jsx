...
const OPCOES = [
    {
      valor: 'porcelana_branca',
      label: 'Porcelana branca',
      subtexto: 'Clássico e elegante',
      icone: 'circle',
    },
    {
      valor: 'ceramica_artesanal',
      label: 'Cerâmica artesanal',
      subtexto: 'Rústico e autêntico',
      icone: 'hand',
    },
    {
      valor: 'vidro_fume',
      label: 'Vidro fumê',
      subtexto: 'Moderno e sofisticado',
      icone: 'square',
    },
    {
      valor: 'colorida',
      label: 'Colorida',
      subtexto: 'Vibrante e personalizada',
      icone: 'palette',
    },
];

export default function Step24Loucas({ onSelect, estadoAtual }) {
  const selecionado = estadoAtual?.loucas;

  return (
    <div
      role="radiogroup"
      aria-label="Qual estilo de louças preferem?"
      style={{
        maxWidth: '640px',
        margin: '0 auto',
        display: 'flex',
    ...
    >
      ...
      <div>
        ...
        <p style={{ fontFamily: 'var(--font-body)', color: 'var(--color-text-secondary)', lineHeight: 'var(--leading-relaxed)' }}>
          Qual estilo de louças preferem?
        </p>
      </div>
        ...
        {OPCOES.map((opcao) => {
          ...
          return (
            <Card
              ...
              selected={isSelected}
              padding="lg"
              onClick={() => onSelect('loucas', opcao.valor)}
              role="radio"
