...
export default function StepB9CursoNoivos({ onSelect, estadoAtual }) {
  ...
  return (
    <div role="radiogroup" aria-label="Curso de noivos" style={{ maxWidth: '640px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 'var(--space-6)', animation: 'fadeInUp 300ms ease-out' }}>
    ...
    >
      <Card key={o.valor} interactive selected={isSelected} padding="lg" onClick={() => onSelect('cursoNoivos', o.valor)} role="radio" aria-checked={isSelected} tabIndex={0} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); onSelect('cursoNoivos', o.valor); } }}>
