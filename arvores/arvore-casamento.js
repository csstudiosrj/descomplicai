...
const ARVORE_CASAMENTO = [
    ...
    { id: 'step00', titulo: 'Perfil do casal', bloco: 'A', componente: 'Step00Casal', next: 'step01' },
    { id: 'step01', titulo: 'Modo de planejamento', bloco: 'A', componente: 'Step01Modo', next: 'step02' },
    ...
    { id: 'step05', titulo: 'Número de convidados', bloco: 'A', componente: 'Step05Convidados', next: 'step06' },
    {
      ...
      next: 'stepA4',
      // Expansão A: se criancas for false, pula stepA4 e stepA5
      condicional: (estado) => {
        if (estado.criancas === false) {
          // pula direto para após stepA5 (ou mantém next se stepA5 tb tiver condição? 
          // Vamos pular toda a cadeia opcional até o próximo obrigatório)
          return 'stepA7'; // stepA6 também é opcional (data prevista), então pulamos A4,A5,A6? 
          // No algoritmo original: se criancas false, stepA4 é pulado. stepA5 é sobre padrinhos, 
          // stepA6 é se data existe. Vou seguir a ordem exata do algoritmo.
          // Melhor: a condicional retorna o id do próximo nó que deve aparecer.
          // Para stepA4: se criancas === false -> pula para stepA5 (não exibe A4).
          // Então condicional em step06 decide: se criancas false, next efetivo = 'stepA5'.
        }
        return undefined; // segue next padrão (stepA4)
      }
    },
    {
    ...
    },
    {
      ...
      next: 'stepA6',
      condicional: (estado) => {
        // Se padrinhosEscolhidos false, pula stepA5
    ...
    // === BLOCO B: Cerimônia ===
    {
      ...
      next: 'step08', // fallback se nenhum ramo for ativado (ex: civil)
      condicional: (estado) => {
        // Ramos religiosos
        ...
        // Se civil ou outro, vai para step08 (next padrão)
        return undefined;
      }
    },
    ...
    // Expansão B
    {
      ...
      next: 'stepB6',
      condicional: (estado) => {
        if (estado.criancas === false) return 'stepB6'; // pula
        return undefined;
      }
    },
    {
      ...
      next: 'stepB7',
      condicional: (estado) => {
        if (estado.tipoCerimonia === 'civil') return 'stepB8'; // pula B6 e B7 (música ao vivo)
        return undefined;
      }
    },
    {
      ...
      next: 'stepB8',
      condicional: (estado) => {
        if (estado.tipoCerimonia === 'civil') return 'stepB8'; // redundante, mas seguro
        return undefined;
      }
    },
    { id: 'stepB8', titulo: 'Reservou igreja/templo', bloco: 'B', componente: 'StepB8ReservouIgreja', next: 'stepB9' },
    {
      ...
      next: 'stepB10',
      condicional: (estado) => {
        if (estado.tipoCerimonia !== 'catolica') return 'stepB11'; // pula B9 e B10
        return undefined;
      }
    },
    {
      ...
      next: 'stepB11',
      condicional: (estado) => {
        if (estado.tipoCerimonia !== 'catolica') return 'stepB11'; // pula
        return undefined;
      }
    },
    {
      ...
      next: 'stepB12',
      condicional: (estado) => {
        if (estado.tipoCerimonia !== 'judaica') return 'stepB13'; // pula B11 e B12
        return undefined;
      }
    },
    {
    ...
    },
    {
      ...
      next: 'stepB14',
      condicional: (estado) => {
        if (estado.tipoCerimonia !== 'simbolica') return 'stepB14'; // pula
        return undefined;
      }
    },
    {
      ...
      next: 'stepB15',
      condicional: (estado) => {
        if (estado.tipoCerimonia !== 'civil') return 'stepB15'; // pula
        return undefined;
      }
    },
    ...
    { id: 'stepB17', titulo: 'Músicos da cerimônia', bloco: 'B', componente: 'StepB17MusicosCerimonia', next: 'stepB18' },
    {
      ...
      next: 'step08',
      condicional: (estado) => {
        if (estado.tipoCerimonia !== 'catolica') return 'step08'; // pula
        return undefined;
      }
    },
    ...
    // Expansão C
    {
      ...
      next: 'stepC5',
      condicional: (estado) => {
        // Pula se local já tem estacionamento (salao, hotel, restaurante)
        if (['salao', 'hotel', 'restaurante'].includes(estado.tipoLocal)) return 'stepC6'; // pula C4 e C5
        return undefined;
      }
    },
    {
    ...
    { id: 'stepC6', titulo: 'Capacidade do local', bloco: 'C', componente: 'StepC6CapacidadeLocal', next: 'stepC7' },
    {
      ...
      next: 'stepC8',
      condicional: (estado) => {
        if (['salao', 'hotel', 'restaurante'].includes(estado.tipoLocal)) return 'stepC8'; // pula
        return undefined;
      }
    },
    ...
    { id: 'stepC9', titulo: 'Reservou local da festa', bloco: 'C', componente: 'StepC9ReservouLocalFesta', next: 'stepC10' },
    {
      ...
      next: 'stepC11',
      condicional: (estado) => {
        if (estado.tipoLocal !== 'praia') return 'stepC11'; // pula
        return undefined;
      }
    },
    ...
    { id: 'stepC12', titulo: 'Convidados de fora', bloco: 'C', componente: 'StepC12ConvidadosForaCidade', next: 'stepC13' },
    {
      ...
      next: 'stepC14',
      condicional: (estado) => {
        if ((estado.convidadosForaCidade || 0) === 0) return 'stepC14'; // pula
        return undefined;
      }
    },
    { id: 'stepC14', titulo: 'Horário da festa', bloco: 'C', componente: 'StepC14HorarioFesta', next: 'stepC15' },
    {
      ...
      next: 'step12', // Próximo bloco D
      condicional: (estado) => {
        if (estado.coquetel !== true) return 'step12'; // pula
        return undefined;
      }
    },
    ...
    { id: 'step14', titulo: 'Paleta de cores', bloco: 'D', componente: 'Step14Paleta', next: 'step15' },
    {
      ...
      next: 'stepD1', // Expansão D
      condicional: (estado) => {
        // step16 só aparece se modo ativo
        if (estado.modoPlanejamento === 'ativo') return 'step16';
        return undefined; // segue para stepD1 (se houver)
      }
    },
    // step16 é opcional (modo ativo), mas não tem next direto; após step16 volta para stepD1.
    // Inserimos step16 como nó, e seu next será stepD1.
    ...
    // Expansão D
    {
      ...
      next: 'stepD2',
      condicional: (estado) => {
        if (estado.flores !== true) return 'stepD2'; // pula
        return undefined;
      }
    },
    {
      ...
      next: 'stepD3',
      condicional: (estado) => {
        if (!estado.tipoIluminacao) return 'stepD3'; // pula
        return undefined;
      }
    },
    {
      ...
      next: 'stepD4',
      condicional: (estado) => {
        if (!estado.mobiliarioQual) return 'stepD4'; // pula
        return undefined;
      }
    },
    ...
    // === BLOCO H: Recepção ===
    {
      ...
      next: 'step39',
      // Expansão G8: mesa de frios se coquetel
      condicional: (estado) => {
        if (estado.coquetel === true) return 'stepG8'; // se tiver coquetel, insere stepG8 antes de step39
        return undefined; // segue para step39
      }
    },
    ...
    { id: 'step39', titulo: 'Bolo, doces e bar', bloco: 'H', componente: 'Step39BoloDocesBar', next: 'stepG9' },
    {
      ...
      next: 'stepG10',
      condicional: (estado) => {
        if (!estado.tipoBar) return 'stepG10'; // pula
        return undefined;
      }
    },
    {
      ...
      next: 'step40',
      condicional: (estado) => {
        if (estado.criancas === false || estado.criancas === 'nao') return 'step40'; // pula
        return undefined;
      }
    },
    { id: 'step40', titulo: 'Música e entretenimento', bloco: 'H', componente: 'Step40MusicaEntretenimento', next: 'stepH3' },
    {
      ...
      next: 'stepH4',
      condicional: (estado) => {
        if (estado.atividadesEntretenimento && !estado.atividadesEntretenimento.includes('fogos')) return 'stepH4'; // pula
        return undefined;
      }
    },
    {
      ...
      next: 'stepH5',
      condicional: (estado) => {
        if (estado.mesaDocesExposta !== true) return 'stepH5'; // pula
        return undefined;
      }
    },
    {
      id: 'stepH5', titulo: 'Aula de dança', bloco: 'H', componente: 'StepH5AulaDanca',
      next: 'step49', // Próximo bloco I
      condicional: (estado) => {
        if (estado.atividadesEntretenimento && !estado.atividadesEntretenimento.includes('aula-danca')) return 'step49'; // pula
        return undefined;
      }
    },
    ...
    { id: 'step55', titulo: 'Beleza e padronização', bloco: 'J', componente: 'Step55BelezaPadronizacao', next: 'stepI4' },
    {
      ...
      next: 'stepI5',
      condicional: (estado) => {
        if (estado.atividadesEntretenimento && !estado.atividadesEntretenimento.includes('aula-danca')) return 'stepI5'; // pula
        return undefined;
      }
    },
    {
      ...
      next: 'stepI6',
      condicional: (estado) => {
        if (estado.mudancaLook !== true) return 'stepI6'; // pula
        return undefined;
      }
    },
    {
      ...
      next: 'step60', // Bloco K
      condicional: (estado) => {
        if (estado.padrinhosEscolhidos !== true) return 'step60'; // pula
        return undefined;
      }
    },
    ...
    { id: 'stepL2', titulo: 'Casamento civil', bloco: 'L', componente: 'StepL2CivilJunto', next: 'stepL3' },
    {
      ...
      next: 'stepL4',
      condicional: (estado) => {
        if (estado.transporteEspecialNoivos !== true) return 'stepL4'; // pula
        return undefined;
      }
    },
    {
      ...
      next: 'stepL5',
      condicional: (estado) => {
        if (estado.carroNoivos === 'nao') return 'stepL5'; // pula
        return undefined;
      }
    },
    {
      ...
      next: 'stepL6',
      condicional: (estado) => {
        if (estado.transporteConvidados === 'nao') return 'stepL6'; // pula
        return undefined;
      }
    },
    {
      ...
      next: 'stepM1', // Bloco M
      condicional: (estado) => {
        // Aparece se evento grande/mega ou se segurança === true
        if (!['grande', 'mega'].includes(estado.totalConvidados) && estado.seguranca !== true) return 'stepM1'; // pula
        return undefined;
      }
    },
    ...
    // === BLOCO M: Pós-casamento ===
    {
      ...
      next: 'stepM2',
      condicional: (estado) => {
        // stepM2 só aparece se luaDeMel for true
        if (estado.luaDeMel !== true && estado.luaDeMel !== 'sim') return 'stepE1'; // pula M2 e vai para Bloco N
        return undefined;
      }
    },
    ...
    { id: 'stepE2', titulo: 'Estado civil da noiva', bloco: 'N', componente: 'StepE2EstadoCivilNoiva', next: 'stepE3' },
    {
      ...
      next: 'stepE4',
      condicional: (estado) => {
        if (estado.estadoCivilNoivo !== 'divorciado') return 'stepE4'; // pula
        return undefined;
      }
    },
    {
      ...
      next: 'stepE5',
      condicional: (estado) => {
        if (estado.estadoCivilNoiva !== 'divorciado') return 'stepE5'; // pula
        return undefined;
      }
    },
    {
      ...
      next: 'stepE6',
      condicional: (estado) => {
        if (estado.estadoCivilNoivo !== 'viuvo') return 'stepE6'; // pula
        return undefined;
      }
    },
    {
      ...
      next: 'stepE7',
      condicional: (estado) => {
        if (estado.estadoCivilNoiva !== 'viuvo') return 'stepE7'; // pula
        return undefined;
      }
    },
    ...
    { id: 'stepE8', titulo: 'Nacionalidade da noiva', bloco: 'N', componente: 'StepE8NacionalidadeNoiva', next: 'stepE9' },
    {
      ...
      next: 'stepE10',
      condicional: (estado) => {
        if (estado.nacionalidadeNoivo === 'brasileiro' && estado.nacionalidadeNoiva === 'brasileiro') return 'stepE10'; // pula
        return undefined;
      }
    },
    ...
    { id: 'stepE14', titulo: 'Horário making of noivo', bloco: 'N', componente: 'StepE14HorarioMakingOfNoivo', next: 'stepE15' },
    {
      ...
      next: 'stepE16',
      condicional: (estado) => {
        if (estado.luaDeMel !== true && estado.luaDeMel !== 'sim') return 'stepE19'; // pula E15-E18
        return undefined;
      }
    },
    {
      ...
      next: 'stepE17',
      condicional: (estado) => {
        if (estado.luaDeMel !== true && estado.luaDeMel !== 'sim') return 'stepE19'; // redundante
        return undefined;
      }
    },
    {
    ...
    { id: 'stepE19', titulo: 'Vacinas', bloco: 'N', componente: 'StepE19Vacinas', next: null } // fim do questionário
  ];
